...
module SpreeTranslate
  class Engine < Rails::Engine
    engine_name 'spree_translate'

    config.autoload_paths += %W(#{config.root}/lib)

    initializer "spree_translate.environment", before: :load_config_initializers do |app|
      SpreeTranslate::Config = SpreeTranslate::Configuration.new
    end

    initializer "spree_translate.permitted_attributes", before: :load_config_initializers do |app|
